execute if score Cache_D computer matches 0 run tellraw @p [{"text":"0x","color":"#A080FF"},{"score":{"name":"EIP","objective":"computer"}},{"text":"d"},{"text":":","color":"white"},{"text":" DEC ","color":"#F92472"},{"text":"EAX","color":"#2472F9"}]
execute if score Cache_D computer matches 1 run tellraw @p [{"text":"0x","color":"#A080FF"},{"score":{"name":"EIP","objective":"computer"}},{"text":"d"},{"text":":","color":"white"},{"text":" DEC ","color":"#F92472"},{"text":"EBX","color":"#2472F9"}]
execute if score Cache_D computer matches 2 run tellraw @p [{"text":"0x","color":"#A080FF"},{"score":{"name":"EIP","objective":"computer"}},{"text":"d"},{"text":":","color":"white"},{"text":" DEC ","color":"#F92472"},{"text":"ECX","color":"#2472F9"}]
execute if score Cache_D computer matches 3 run tellraw @p [{"text":"0x","color":"#A080FF"},{"score":{"name":"EIP","objective":"computer"}},{"text":"d"},{"text":":","color":"white"},{"text":" DEC ","color":"#F92472"},{"text":"EDX","color":"#2472F9"}]

execute if score Cache_D computer matches 0 run scoreboard players remove EAX computer 1
execute if score Cache_D computer matches 1 run scoreboard players remove EBX computer 1
execute if score Cache_D computer matches 2 run scoreboard players remove ECX computer 1
execute if score Cache_D computer matches 3 run scoreboard players remove EDX computer 1
