tellraw @p [{"text":"0x","color":"#A080FF"},{"score":{"name":"EIP","objective":"computer"}},{"text":"d"},{"text":":","color":"white"},{"text":" JZ ","color":"#F92472"},{"text":"0x","color":"#2472F9"},{"score":{"name":"Cache_D","objective":"computer"},"color":"#2472F9"},{"text":"d","color":"#2472F9"}]
...
execute if score ZF Flags matches 1 run scoreboard players operation EIP computer = Cache_D computer
